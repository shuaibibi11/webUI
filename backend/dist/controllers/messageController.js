...
exports.searchMessages = exports.getUnreadCount = exports.markMessagesAsRead = exports.getMessages = exports.sendMessage = exports.sendMessageValidation = void 0;
...
const getMessages = async (req, res) => {
    try {
        ...
        const before = req.query.before; // 获取指定时间之前的消息（用于上拉加载）
        // 检查对话是否存在且属于当前用户
        const conversation = await prisma_1.prisma.conversation.findFirst({
            where: { id: conversationId, userId }
        });
